...
This is the workshop website for the 2023 Posit Conference Shiny for Python Workshop. 
...
If you would like help hosting a Shiny for Python workshop of would like to book a webinar, please contact us on [Discord](https://discord.gg/AQVJzG2bnN).


# Background

This workshop is aimed at people who are somewhat familliar with doing data analysis in Python, but do not have much of a background in Shiny. If you are brand new to Python we recommend spending a bit of time familliarizing yourself with the following topics before the workshop: - How to install python packages in a virtual environment - How to do basic data manipulation with pandas or polars - How to draw plots - How to clone a repository with git
...
Alternately, run them from the command line with `shiny run <path-to-app> --reload`.