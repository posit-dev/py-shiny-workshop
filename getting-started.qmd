...
1) Add a `ui.input_numeric` to your UI which identifies the multiplier. Use this to all people to change the multiplier from the hard coded value of 2 to another number. 
