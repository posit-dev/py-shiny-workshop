...
problem_tabs("apps/problem-sets/4-ui-customization/4.0-add-sidebar")
```
...
problem_tabs("apps/problem-sets/4-ui-customization/4.1-rows-and-columns")
```
...
problem_tabs("apps/problem-sets/4-ui-customization/4.2-value-boxes")
```
...
problem_tabs("apps/problem-sets/4-ui-customization/4.3-style-changes")
```
