...
#| output: asis  
 include_shiny_folder(
     "apps/problem-sets/1-getting-started/1.10-add-plot", file_name="app-solution.py", exclusions=["app.py"]
 )
```
:::
...
#| echo: false
#| output: asis  
problem_tabs("apps/problem-sets/2-reactivity/2.2-reactive-calc")
```
:::
