...
- By default, any change in an input will trigger immediate recalculation in all outputs that use it
...
TODO: Shouldn't this be showing app-solution.py, not app.py?
...
- How Shiny detects dependencies between elements (renders and inputs)
